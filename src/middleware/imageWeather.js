...
export const imageWeather = (weatherId) => {
  let weatherImageUrl = "";

  if (weatherId) {
    if (weatherId <= 804 && weatherId >= 800)
      weatherImageUrl = images["sunny.png"];
    else if (weatherId <= 781 && weatherId >= 701)
      weatherImageUrl = images["sunny.jpg"];
    else if (weatherId <= 321 && weatherId >= 300)
      weatherImageUrl = images["cloudy.jpg"];
    else if (weatherId <= 531 && weatherId >= 500)
      weatherImageUrl = images["rainy.jpg"];
